import { Paciente, PrestadorMedico, Cita, SolicitudListaEspera } from './types/models.js';
...
const listaEspera: SolicitudListaEspera[] = [
...
const nuevaCitaInvalida: Partial<Cita> = { id: 'C104', pacienteId: 'P001' }; // Le faltan datos

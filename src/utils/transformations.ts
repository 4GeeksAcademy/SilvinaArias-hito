import { Cita, PrestadorMedico, Factura } from '../types/models.js';
import { esCancelacionATiempo } from './validations.js';

// Calcular duracion promedio de citas
export function calcularPromedioDuracionCitas(citas: Cita[]): number {
  if (citas.length === 0) return 0; // Caso límite
...
export function generarFacturaCancelacion(
  cita: Cita, 
  medico: PrestadorMedico, 
